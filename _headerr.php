			...
			<div id="header">
				...
				<ul id="main-nav">
					...
					<li>
						...
						<a href="home_comm.php" class="<?= $menu[0]; ?>">
					...
					<li>
						...
						<a href="commclients.php" class="<?= $menu[1]; ?>"><!-- use href="#" to indicate there's a submenu -->

							 clients de <?= $cm['pnom_comm']?> 
                    ...
                    <li>
						...
						<a href="Comm_rappels.php" class="<?= $menu[3]; ?>">

							 rappels de <?= $cm['pnom_comm']?> 
