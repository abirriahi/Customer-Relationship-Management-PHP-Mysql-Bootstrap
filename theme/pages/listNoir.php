...
$listNoir = $myadmin->ClientListeNoire();
$nbrlistNoir = sizeof($listNoir);
...
if(isset($_POST['saveme']))
{
 ...
 $zero=0 ;
	foreach($ed_selectionne as $key=>$value)
	{
		...
		$myadmin->UpdateLiOuvClient($value,$zero);
	}
}
?> 
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
           LISTE NOIRE
            <small><a href="listNoir.php">Tous </a></small>
        </h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
		...
		<div class="row">
            ...
            <div class="box-header">
              <h3 class="box-title">LISTE NOIRE DES CLIENT </h3>
            </div>
                <div class="box-body">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="total_clients.php?idclient?cdr=ok&c=<?= $mcls['id_cl'] ?>"> <button type="button" class="btn btn-danger btn-ok">Confirmé</button></a>
                </div>
            </div>
        </div>
    </div>  
