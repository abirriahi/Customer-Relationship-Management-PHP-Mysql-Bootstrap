...
<!-- bootstrap wysihtml5 - text editor --><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
...
<button type="button" class="btn btn-default btn-sm" title="Ce client n'appartient pas à votre liste clients   !"  disabled="disabled" data-toggle="modal" data-target="#listnoire" ><i class="fa fa-minus-circle text-black"></i></button>		  
				<?php  
				$exist= $myadmin->Exist_Li_Ouv($client) ;
	            if($exist==1){ ?>
		        <button type="button" class="btn btn-default btn-sm" title="Ce client n'appartient pas à votre liste clients   !"  disabled="disabled" data-toggle="modal" data-target="#listouv" ><i class="fa fa-caret-square-o-left text-yellow"></i></button>
                <?php }	else {	?>        
				<button type="button" class="btn btn-default btn-sm disabled" title="Ce client n'appartient pas à votre liste clients   !"  disabled="disabled" data-toggle="modal" data-target="#listouv" ><i class="fa fa-caret-square-o-left text-yellow"></i></button>
				 <?php } ?>
				<button type="button" class="btn btn-default btn-sm" title="Ce client n'appartient pas à votre liste clients   !"  disabled="disabled" data-toggle="modal" data-target="#supprimer" ><i class="fa fa-trash-o text-red"></i></button>
...
<!-- /.content-wrapper -->
<!-- Bootstrap WYSIHTML5 --><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
