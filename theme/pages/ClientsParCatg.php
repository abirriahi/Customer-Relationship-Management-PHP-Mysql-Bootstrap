...
$ListeClientsParSecteurs = $myadmin->ListeClientsParSecteurs($_GET['catg']);

$secteur = $myadmin->AfficherSecteur($_GET['catg']);

$nbrListeClientsParSecteurs = sizeof($ListeClientsParSecteurs);
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Liste Clients Par Secteurs 
            <small><a href="ClientsParCatg.php">Tous </a></small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> HOME</a></li>
            <li><a href="#">CLIENT</a></li>
            <li class="active">Liste Clients Par Secteurs <?= $secteur['libelle_clcat']?></li>
        </ol>
    </section>
	...
	<?php
		...
		<div class="row">
            ...
            <div class="box-header">
              <h3 class="box-title">Liste Clients Par Secteurs  : <?= $secteur ?></h3>
            </div>
                <div class="box-body">
				  <div class="box-tools">
                <!-- Check all button -->
...
<?php
$nb=0;
foreach ($ListeClientsParSecteurs as $mcls) {
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="mesclients.php?cdr=ok&c=<?= $mcls['id_cl'] ?>"> <button type="button" class="btn btn-danger btn-ok">Confirmé</button></a>
                </div>
            </div>
        </div>
    </div>  
