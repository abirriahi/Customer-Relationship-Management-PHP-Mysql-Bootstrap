		...
		<div class="row">
            ...
            <div class="box-header">
              <h3 class="box-title">LISTE DE MES CLIENTS</h3>
                ...
                <div class="btn-group">
			   	  <button type="button" class="btn btn-default" title="Rediriger clients Vers liste ouverte !" data-toggle="modal" data-target="#listouv" ><i class="fa fa-caret-square-o-left text-yellow"></i></button>
				 ...
				 <a href="Export.php?action=mesclient" target="_blank" ><button type="button" class="btn btn-default" title="Télécharger la liste  !" ><i class="fa fa-cloud-download text-green"></i></button> </a> 
				  <?php } ?>
