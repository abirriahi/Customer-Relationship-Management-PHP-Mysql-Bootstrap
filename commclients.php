...
{
	$mesclient = $myadmin->ClientInteresseParCommercial($_GET['interesse'],$_SESSION['commercial']);	
...
{       
         if($_GET['activite']==0)
		 {
			 $mesclient = $myadmin->FiltreParVille($_GET['ville'],$_SESSION['commercial']);
        ...
        {
			$mesclient = $myadmin->FiltreParCategorie($_GET['activite'],$_SESSION['commercial']);
	         $act = $myadmin->AfficherSecteur($_GET['activite']);
	         $vil = $myadmin->NomVille($_GET['ville']);
...
{
	$mesclient = $myadmin->FiltreCategorieVille($_GET['activite'],$_GET['ville'],$_SESSION['commercial']);
...
{
	$mesclient = $myadmin->ListeClientsParCommercial($_SESSION['commercial']);
...
$cm = $myadmin->commercial_by_id($_SESSION['commercial']);
                ...
                <h2><img src="images/icons/tools_32.png" alt="Manage Users" /><?= $cm['nom_comm']?> <?= $cm['pnom_comm']?> clients</h2>
			...
			<div id="content">
                ...
                <table rel="12"><!-- add the class .pagination to dynamically create a working pagination! The rel-attribute will tell how many items there are per page -->
                     ...
                     <div class="content-box-header">
						...
						<h3><a href="commclients.php">Tous </a></h3>
                ...
                <div class="content-box column-left main" style="width:100%;">
					...
					<div class="content-box-header">
						...
						<h3>Liste des clients <?php if(isset($filtre)) echo ' : '. $filtre;?></h3>
