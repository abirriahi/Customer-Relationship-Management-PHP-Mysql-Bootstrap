...
*/
	...
	// Tooltip-confirmation
		...
		$('.confirm > a').click(function() {
			...
			$(this).parent().append('<div class="tooltip"><p>Vous êtes sûre?</p><a href="' + link + '">Oui</a> | <a href="#" class="close">Non</a></div>'); // Adding the tooltip to the DOM
	...
	// Awesome tables with dynamically generated pagination
		...
		$('table.pagination').each(function() {
			...
			$(this).find(".pagination").append('<a href="#first" rel="first">Premier</a>');
			...
			$(this).find(".pagination").append('<a href="#last" rel="last">Dernier</a>');
